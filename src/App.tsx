...
// ═══════════════════════════════════════════════════════════════════════════
// ✏️  РЕДАКТИРУЙ ТОЛЬКО ЭТУ СЕКЦИЮ — письмо №2
// ═══════════════════════════════════════════════════════════════════════════
const LETTER = {
  // ID → имя файла public/data/chats/person-2.json
  timlidId: 'person-2',
  ...
  intro: [
    'Если бы у меня была бы возможность пробыть еще сотню смен...',
    'Я бы хотел быть на каждой из них - с тобой.',
  ],

  // Заключение перед подписью
  closing:
    'Последнее письмо, последнему тимлидеру. (не последнее)',

  // Первое слово подписи
  signature: 'Всегда твой ИКТ',
}
// ═══════════════════════════════════════════════════════════════════════════
